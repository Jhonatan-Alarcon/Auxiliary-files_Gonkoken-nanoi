...
#######################################################
# SETUP: YOUR FILE AND GEOGRAPHY FILE
#######################################################

#MCCT<-obtainDatedPosteriorTreesMrB(
  #runFile = "Gonkoken_v3_dated_gamma_2.nex.run1.t",
  #nRuns = 2,
  #burnin = 0.5,
  #outputTrees= "MCCT",
  #labelPostProb = TRUE,
...
#Root time (MCCT$root.time): 129.819 Ma
...
plot(read.tree("Gonkoken_MCCT_tree.newick"))
title("Hadros_MCMCT")
...
moref("Gonkoken_geog.data.txt")

# Look at your geographic range data:
tipranges = getranges_from_LagrangePHYLIP(lgdata_fn="Gonkoken_geog.data.txt")
tipranges
...
BioGeoBEARS_run_object$trfn = "Gonkoken_MCCT_tree.newick"

# Give BioGeoBEARS the location of the geography text file
BioGeoBEARS_run_object$geogfn = "Gonkoken_geog.data.txt"
...
BioGeoBEARS_run_object$dispersal_multipliers_fn = "Dispersal_matrix_hadros.txt"
...
runslow = TRUE
resfn = "Hadros_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
{
...
resfn = "Hadros_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "Hadros_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=16)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Hadros M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=ladderize(read.tree(results_object$inputs$trfn),right = TRUE))

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Hadros M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE)
...
runslow = TRUE
resfn = "Hadros_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Hadros_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Hadros_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=16)
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE)
...
pdffn = "Hadros_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
...
samplesize = length(read.tree("Gonkoken_MCCT_tree.newick")$tip.label)
